...
def validate(chain_spec: dict) -> tuple[dict, list[dict]]:
    ...
    #    per-sample failure diagnostics in step 8). Defaults to 300 to
    #    preserve scoring continuity; ``HOTPOTQA_STATIC_N_SAMPLES``
    #    overrides for smoke / higher-fidelity sweeps.
